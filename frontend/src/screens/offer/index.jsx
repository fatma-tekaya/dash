  ...
  return (
    <div className="container ">
      <div className="crud shadow-lg p-3 mb-5 mt-5 bg-body rounded">
        <div className="row ">
          <div
            className="col-12 col-sm-12 offset-sm-1 mt-5 mb-4 text-gred"
            style={{ color: "teal" }}
          >
            <h2>
              <b>Liste des offers</b>
            </h2>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <Alert show={showAlertEdit} variant="success">
            Offre s avec succès
            <button
              onClick={() => setShowAlertEdit(false)}
              className="close"
              aria-label="Close"
            >
              ...
              >
                ...
                <div className="form-floating mb-3">
                  <input
                    ...
                    id="date_pub"
                    name="date_pub"
                    value={editData.date_pub}
                    onChange={(e) =>
                      seteditData({ ...editData, date_pub: e.target.value })
                    }
                  />
            ...
            <Modal.Footer>
              <div className="row">
                <Alert show={showAlertAdd} variant="success">
                  Offre ajouter avec succès! Si vous voulez vous pouvez ajouter
                  un autre offre.
                  <button
                    onClick={() => setShowAlertAdd(false)}
                    className="close"
                    aria-label="Close"
                  >
                    <span aria-hidden="true">&times;</span>
